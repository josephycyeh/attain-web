...
export function useGetItemsByFilterLazyQuery(
  ...
  return Apollo.useLazyQuery<
    GetItemsByFilterQuery,
    GetItemsByFilterQueryVariables
  >(GetItemsByFilterDocument, options);
}
export type GetItemsByFilterQueryHookResult = ReturnType<
  typeof useGetItemsByFilterQuery
>;
export type GetItemsByFilterLazyQueryHookResult = ReturnType<
  typeof useGetItemsByFilterLazyQuery
>;
...
`;
export type SubmitOrderMutationFn = Apollo.MutationFunction<
  SubmitOrderMutation,
...
export function useSubmitOrderMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<SubmitOrderMutation, SubmitOrderMutationVariables>(
    SubmitOrderDocument,
    options
  );
}
...
export type SubmitOrderMutationResult =
  Apollo.MutationResult<SubmitOrderMutation>;
export type SubmitOrderMutationOptions = Apollo.BaseMutationOptions<
  SubmitOrderMutation,
  SubmitOrderMutationVariables
>;
...
`;
export type UpdateItemInCartMutationFn = Apollo.MutationFunction<
...
export function useUpdateItemInCartMutation(
  ...
  return Apollo.useMutation<
    UpdateItemInCartMutation,
    UpdateItemInCartMutationVariables
  >(UpdateItemInCartDocument, options);
}
export type UpdateItemInCartMutationHookResult = ReturnType<
  typeof useUpdateItemInCartMutation
>;
export type UpdateItemInCartMutationResult =
  Apollo.MutationResult<UpdateItemInCartMutation>;
export type UpdateItemInCartMutationOptions = Apollo.BaseMutationOptions<
  UpdateItemInCartMutation,
  UpdateItemInCartMutationVariables
>;
